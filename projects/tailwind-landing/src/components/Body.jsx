...
const Body = () => {
  return (
    <div className="space-y-4 lg:flex">
      ...
      <div className="md:space-y-4 lg:flex-1 lg:order-1">
        <h1 className="text-5xl font-bold font-playfair leading-tight">
          Host your website in less than 5 minutes
        </h1>
        <p className="font-lato text-gray-400">
          With Hoster, get your website and running in no less than 5 minutes
        ...
        <form action="" className="flex flex-col gap-4 md:flex-row">
          ...
          />
          <button className="rounded-md px-4 py-3 bg-blue-400 hove:bg-blue-600 text-white">
            Join Waitlist
          </button>
        </form>
